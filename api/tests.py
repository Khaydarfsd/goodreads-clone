...
class BookReviewAPITestCase(APITestCase):
    def setUp(self):
        self.user = CustomUser.objects.create(username='khaydar', first_name='Khaydar')
    ...
    def test_book_review_detail(self):
        ...
        self.assertEqual(response.data['user']['first_name'], 'Khaydar')
        self.assertEqual(response.data['user']['username'], 'khaydar')
