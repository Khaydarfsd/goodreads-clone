...
class BooksTestCase(TestCase):
    ...
    def test_books_list(self):
        ...
        book2 = Book.objects.create(title='Book2', description='Description2', isbn=123124)
        book3 = Book.objects.create(title='Book3', description='Description3', isbn=123125)

        response = self.client.get(reverse('books:list') + "?page_size=2")

        for book in [book1, book2]:
            self.assertContains(response, book.title)
        self.assertNotEquals(response, book3.title)
    ...
    def test_search_books(self):
        ...
        book2 = Book.objects.create(title='Guide', description='Description2', isbn=123124)
        book3 = Book.objects.create(title='Shoe Dog', description='Description3', isbn=123125)
